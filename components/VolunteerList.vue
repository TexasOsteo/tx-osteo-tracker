...
<template>
  <div v-if="isAdmin">
    <div><h1 class="text-center text-2xl mb-5 mt-5">VOLUNTEER LIST</h1></div>
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
      ...
      >
        <thead
          class="text-xs text-gray-700 uppercase bg-gray-500 dark:bg-gray-500 dark:text-gray-800"
        >
          <tr>
        ...
        <tbody>
          <tr
            ...
            :key="user.id"
            class="bg-white border-b dark:bg-white-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
            <td class="px-6 py-3">
              {{ user.name }}
            </td>
