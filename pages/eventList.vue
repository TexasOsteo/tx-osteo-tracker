...
<template>
  <div
    class="bg-white mx-20 p-5 my-10 rounded-lg shadow-xl flex flex-wrap block lg:w-1/2 lg:mx-auto"
  >
    <div class="flex flex-wrap mb-5 w-[90%]">
      ...
      <div v-if="!isExpanded" class="flex flex-wrap mt-5">
        <div class="flex flex-wrap items-center mt-5">
          ...
          <h3 class="mr-20 ml-3">Organizer</h3>
        </div>
        <div class="flex flex-wrap items-center mt-5">
          <div>
            <svg
        ...
        <div class="flex flex-wrap items-center mt-5">
          ...
          <h3 class="mr-20 ml-3">Date and Time</h3>
        </div>
      </div>
      <div
        v-if="isExpanded"
        ...
        <ul class="w-full mb-5 block sm:w-1/2">
          ...
          <li>
            <div class="flex flex-wrap items-center mt-5">
              ...
              <h3 class="mr-20 ml-3">Volunteer Positions</h3>
            </div>
          </li>
